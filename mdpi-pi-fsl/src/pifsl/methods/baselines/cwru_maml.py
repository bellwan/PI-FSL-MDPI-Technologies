from pifsl.data.cwru.datasets import CWRU, CWRU_FFT, HST, HST_FFT
from pifsl.methods.baselines.cwru_models import CNN1D
from pifsl.data.cwru.utils import (
    print_logs,
    fast_adapt,
)
...
RESULTS_DIR = PROJECT_ROOT / "cross_domain_fsl" / "results"
    ...
    append_metrics(
        {
            ...
            "dataset": args.dataset.lower(),          # 'cwru' or 'hst'
            "method": "maml",
